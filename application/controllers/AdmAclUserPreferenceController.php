 ...
 *
 */
class AdmAclUserPreferenceController extends GD_Controller_Admin
{
...
//		$this->view->paginator=$paginator;
	...
	public function addAction(){
		...
		// Manage Form Display
		$form = new ADMIN_Form_Admin_ACL_UserPreference_Add();
		if ($this->_request->isPost()) {
			$formData = $this->_request->getPost();
			if ($form->isValid($formData)) {
				echo 'success';
...
//		$paginator = new Zend_Paginator($adapter);
	...
	public function editAction(){
		...
		$form = new ADMIN_Form_Admin_ACL_UserPreference_Edit($form_options, $form_data);
		if ($this->_request->isPost()) {
			$formData = $this->_request->getPost();
			if ($form->isValid($formData)) {
				echo 'success';
