<?php
/**
 * Admin Admin Acl User Object Controller
 *
 * @author Terence
 ...
 *
 */
class AdmAclUserObjectController extends GD_Controller_Admin
{
...
//		$this->view->paginator=$paginator;
	...
	public function addAction(){
		...
		// Manage Form Display
		$form = new ADMIN_Form_Admin_ACL_UserObject_Add();
		if ($this->_request->isPost()) {
			$formData = $this->_request->getPost();
			if ($form->isValid($formData)) {
				echo 'success';
//				var_dump ($formData); exit;
	...
	public function editAction(){
		...
		$form = new ADMIN_Form_Admin_ACL_UserObject_Edit($form_options, $form_data);
		if ($this->_request->isPost()) {
			$formData = $this->_request->getPost();
			if ($form->isValid($formData)) {
				echo 'success';
